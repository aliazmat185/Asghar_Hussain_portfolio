...
export const services: Service[] = [
  {
    ...
    icon: TikTokIcon,
    featured: true,
    tagline: "Boost your views, likes, and follower engagement — with a real strategy behind it.",
    description:
      "A structured approach to growing your TikTok presence: more views, more likes, and a more engaged following, built through content strategy and targeted advertising rather than shortcuts. Alongside growth, you get clear guidance on what it takes to become monetization-ready.",
    highlights: [
      "Boost views, likes & follower engagement",
    ...
    covers: [
      ...
      "Boosting views and likes through targeted content and promotion",
      "Engaging your existing followers and growing an active, returning audience",
